...
class CustomShape {
  ...
  void makeBody(float x, float y) {
    ...
    toxiPoly = new Circle(random(5, 20)).toPolygon2D(int(6)); // Changes how many points shape will have
...
//    print(col);
  ...
  boolean done() {
    ...
    Vec2 posScreen = box2d.getBodyPixelCoord(body);
    boolean offscreen = posScreen.y > height; // using height was killing shapes too early on lower resolutions
